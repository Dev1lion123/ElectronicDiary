...
namespace Common
{
    public static partial class ExtensionMethods
    {
        ...
        /// <remarks>Если класс <typeparamref name="T"/> реализует интерфейс <see cref="ICloneable{T}"/>,
        /// то копия создаётся методом <see cref="ICloneable{T}.Clone"/>.<br/>
        /// Если класс <typeparamref name="T"/> реализует интерфейс <see cref="ICloneable"/>,
        /// то копия создаётся методом <see cref="ICloneable.Clone"/>.<br/>
        /// Иначе - методом 
